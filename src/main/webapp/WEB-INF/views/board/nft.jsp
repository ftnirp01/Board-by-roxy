                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up" data-aos-delay="200">
                            <div class="blog-item">
                                ...
                                <div class="blog-text">
                                    <div class="blog-tag">
                                        <a href="javascript:alert('준비중입니다.')"><h6><small>Biology</small></h6></a>
                                    </div>
                                    <div class="blog-title">
                                        <a href="javascript:alert('준비중입니다.')"><h4>탄생의 미</h4></a>
                                    </div>
                                    <div class="blog-meta">
                                        <p class="blog-date">2020/4/27</p>
                                    </div>
                                    <div class="blog-desc">
                                        <p>탄생은 곧 축복 근본적인 아름다움</p>
                                    </div>
                                    <div class="blog-author">
                                        <p>620,000  won</p>
                                    </div>
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up" data-aos-delay="400">
                            <div class="blog-item">
                                ...
                                <div class="blog-text">
                                    <div class="blog-tag">
                                        <a href="javascript:alert('준비중입니다.')"><h6><small>Art</small></h6></a>
                                    </div>
                                    <div class="blog-title">
                                        <a href="javascript:alert('준비중입니다.')"><h4>추상의 미</h4></a>
                                    </div>
                                    <div class="blog-meta">
                                        <p class="blog-date">2022/1/17</p>
                                    </div>
                                    <div class="blog-desc">
                                        <p>여러 관점으로 볼 수 있는 추상의 미<br> 대중들에게 많은 의미를 전달해주는 매개체</p>
                                    </div>
                                    <div class="blog-author">
                                        <p>345,000  won</p>
                                    </div>
